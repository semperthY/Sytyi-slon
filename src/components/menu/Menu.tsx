  ...
  useEffect(() => {
    ...
    async function loadCategory(
      ...
      const response = await fetch(
        `/data/menu/${slug}.json?v=${timestamp}`,
        {
          cache: "no-store",
        },
      );
            ...
            return (
              ...
              >
                <button
                  type="button"
                  onClick={() =>
                    setOpened(isOpened ? "" : categoryKey)
                  }
                ...
                >
                  ...
                  <svg
                    ...
                    fill="none"
                    aria-hidden="true"
                    className={`h-6 w-6 shrink-0 text-yellow-400 transition-transform duration-300 ${isOpened ? "rotate-180" : ""
                      }`}
                  >
                    <path
                      d="m6 9 6 6 6-6"
